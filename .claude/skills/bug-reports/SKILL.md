...
Severity: Sev-1..4 | Status: Open | Found: <date> | TC: TC-### | REQ: REQ-### | Ticket: VS-##
...
## Severity rubric
- Sev-1: integrity/compliance broken — overbooking, data visible across facilities, Aadhaar
  accepted anywhere, certificate for a vaccination that didn't happen. Release-blocking, stop-and-report.
