---
name: lwc-slds2
description: LWC best practices (HTML, CSS, JS) and SLDS 2 styling rules for the <domain-item> scheduler UI. Used by dev-senior for LWCs and dev-mid for simple components; qa-engineer reads the accessibility section.
---

# LWC + SLDS 2 Best Practices

## Component design
- Small and single-purpose: pfxExampleCmp, pfxExampleConsole, vsCertificateCard — compose, don't grow.
...
- Wire adapters (@wire + getRecord/graphql) for reads; imperative Apex only for actions
  (book, cancel, check-in). One Apex controller per component family: PFX_SlotPickerController.
