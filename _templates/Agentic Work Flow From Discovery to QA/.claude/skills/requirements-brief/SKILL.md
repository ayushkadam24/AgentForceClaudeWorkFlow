...
description: How to write the requirements brief and open-questions register for the <domain-item>-scheduler POC. Used by ba-analyst during DISCOVERY.
---
...
3. Requirements register — a table per capability area (citizen booking; staff/check-in;
   <domain> recording & stock; follow-up & reminders; certificates; dashboards & admin;
